...
function pandoc.utils.blocks_to_inlines(blocks) end

---type is Lua's default type that prints __name if it is present.
---It prints "Inlines" and "Blocks" for pandoc.Inlines and pandoc.Blocks respectively.
---@param v any
---@return string
function pandoc.utils.type(v) end
...
---@field clone fun(self: pandoc.Pandoc): pandoc.Pandoc
local Pandoc = {}
...
---@field tag "Table"
---@field clone fun(self: pandoc.Table): pandoc.Table
...
---@field title string
---@field tag "Link"
---@field clone fun(self: pandoc.Link): pandoc.Link
...
---@field clone fun(self: pandoc.Attr): pandoc.Attr
